...
const AlumniList = [
  ...
  },
  {
    ...
    award: "Bhatnagar Awardee",
    name: "Mr. Aloke Paul",
    dgp_year: "1996, B.E., Metullurgical and Materials Engg.",
    photo: "assets/images/alumni/aloke_paul.jpg",
    curr_post: "Professor, IISc Bangalore"
  },
  {
    id: 14,
...
const Alumni = () => {
  ...
  return(
    <Container>
      ...
      >
        The institute stays in constant touch with its alumni strengthening the
        alumni-student interaction. The institute has numerous alumni not only
        in India but in many foreign countries who have went on to become the
        masters of their fields and have acquired top positions. We have the
        Centre for Alumni Affairs & International Relations (CAAIR) that acts
        as a platform to unite all the alumni across the world to connect with
        their alma mater. Some of our alumni are presented below.<br /><br />
